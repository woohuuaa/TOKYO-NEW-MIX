...
function displayArtist(artist) {
    ...
    selectedArtistTitle.innerHTML = artist.name + " (" + artist.urls.map((urls)=>`<a href="${urls.url}" target="_blank">${urls.name}</a>`).join(", ") + ")";
}
...
function displaySongs(artist) {
    ...
    // c.	Filter your Songs Array for the chosen Artist / NOT flagged (explicit == false)
